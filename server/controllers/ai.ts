...
export async function analyzeBusinessMetrics(req: Request, res: Response) {
  ...
  try {
    ...
    const systemInstruction = "You are an expert Chartered Accountant, Indian GST consultant, and Business Growth strategist for Indian small businesses. Write a professional, highly readable report in markdown format. Be direct, clear, action-oriented, and structured with elegant headers.";
